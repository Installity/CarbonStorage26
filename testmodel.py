...
#Environmental trend graph
    plt.figure()
    plt.plot(results["AverageMoisture"], label="Average Moisture")
    plt.plot(results["AverageFireRisk"], label="Average Fire Risk")
    plt.xlabel("Step")
    plt.ylabel("Value")
    plt.title("Environmental Risk Trends")
    plt.legend()
    plt.show()

#Forest state counts
    plt.figure()
    plt.plot(results["StressedCount"], label="Stressed")
    plt.plot(results["BurningCount"], label="Burning")
    plt.plot(results["BurnedCount"], label="Burned")
    plt.xlabel("Step")
    plt.ylabel("Patch Count")
    plt.title("Forest State Counts")
    plt.legend()
    plt.show()

#Carbon scenario comparison
    plt.figure()
    plt.plot(baseline["TotalCarbon"], label="Baseline")
    plt.plot(drought["TotalCarbon"], label="Drought")
    plt.plot(wildfire["TotalCarbon"], label="Wildfire Escalation")
    plt.xlabel("Step")
    plt.ylabel("Total Carbon")
...
#Adaptive comparison
    ...
    plt.title("Adaptive Response Comparison")
    plt.legend()
    plt.show()
...
# Graphs originally for testing and verification.
    # plt.figure()
